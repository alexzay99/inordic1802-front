<template>
    ...
    <footer>
        ...
        <div>
            <div>
                <h3 class="uppercase">Мы в социальных сетях</h3>
                <nav>
                ...
                <nav class="social">
                    <span>
                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter" role="img"
                             ...
                             class="svg-inline--fa fa-twitter fa-w-16 fa-2x"><path fill="currentColor"
                    ...
                    <span>
                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook-f" role="img"
                             ...
                             class="svg-inline--fa fa-facebook-f fa-w-10 fa-2x"><path fill="currentColor"
                    ...
                    <span>
                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram" role="img"
                             ...
                             class="svg-inline--fa fa-instagram fa-w-14 fa-2x"><path fill="currentColor"
